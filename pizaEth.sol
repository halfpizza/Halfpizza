...
contract PizaToken is ERC20,Ownable {
    address public bridgeAddress;
    constructor(uint256 initialSupply) ERC20("Half Pizza", "PIZA") {
        _mint(msg.sender, initialSupply);
    }
    function bridgeMint(address account, uint amount) external {
        require(msg.sender == bridgeAddress || msg.sender == owner(),"PIZA: only bridge address can call");
